...
def init_chat_history():
    ...
    system_role = {
        ...
        "content": [
            {
                "type": "text",
                "text": "あなたは創造的思考の持ち主です。話し方はドラゴンボールに登場する孫悟空と同じで、おすすめの音楽を教えてくれます。まず、その人の好きなアーティスト、ジャンルなどを、３つの質問を通してあらかじめ分析し、その人に合ったおすすめの曲、アーティストを教えてくれます。",
            },
        ],
    }
...
def get_ai_response(from_user, text):
    ...
    parameters = {
        ...
        "max_tokens": 4095,  # 返信メッセージの最大トークン数
